...
export async function crearViatico(req, res) {
  const {
    ...
    destino,
    fechaDeSalida,
    // OJO: el form viejo manda "fechaDellegada"
    // el nuevo podría mandar "fechaDeLlegada"
    // luego abajo unificamos en una sola constante
    adicionalEnEfectivo,
    devolucionEnEfectivo,
    valesCombustible,
    valorVale,
  ...
  const fechaDeLlegada =
    req.body.fechaDeLlegada || req.body.fechaDellegada || null;
  ...
  const nuevoViatico = new Viatico({
    ...
    destino,
    fechaDeSalida,
    fechaDeLlegada, // ← ahora nunca va undefined si viene del form
    montoTotalViatico: montoTotal,
    adicionalEnEfectivo: adicional,
    devolucionEnEfectivo: rendido,
    pendienteDeRendicion: adicional - rendido,
...
export async function actualizarViatico(id, datos) {
  const {
    ...
    totalVale,
    valesCombustible,
    // puede venir fechaDeLlegada o fechaDellegada
  } = datos;

  const fechaDeLlegada =
    datos.fechaDeLlegada || datos.fechaDellegada || null;
